        ...
        return $schema
            ->components([
                    ...
                    ->schema([
                        Grid::make(2)->schema([
                            TextInput::make('title')
                                ...
                                ->placeholder('e.g. Health Certificate 2026, ID Copy')
                                ->required()
                                ->maxLength(255),
                ...
                Section::make('File Upload')
                    ->description('Upload medical forms, identity documents, or liability waivers.')
        ...
        return $table
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->modalHeading('Upload Camper Document')
                    ->modalWidth('4xl'),
            ])
            ->actions([
                ActionGroup::make([
